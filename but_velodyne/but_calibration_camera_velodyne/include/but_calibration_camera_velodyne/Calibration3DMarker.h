...
public:
  ...
  bool detectCirclesInPointCloud(std::vector<cv::Point3f> &centers, std::vector<float> &radiuses, pcl::PointCloud<pcl::PointXYZ> & detectionPC);
...
protected:
  ...
  std::vector< ::pcl::PointXYZ > refine4centers_nuestro(std::vector< ::pcl::PointXYZ > centers,
                                            ::pcl::PointCloud< ::pcl::PointXYZ >::Ptr detection_cloud);
