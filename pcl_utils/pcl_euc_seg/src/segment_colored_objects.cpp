...
cloud_cb (const sensor_msgs::PointCloud2ConstPtr& cloud_msg)
{
  ...
  // SE ITERA PARA CADA UNO DE LOS OBJETOS
  int j = 0;
  ...
  // A PARTIR DE AQUI IRIA TU CODIGO
...
{
  // Initialize ROS
  ros::init (argc, argv, "euc_seg");
  ros::NodeHandle nh;

  // Create a ROS subscriber for the input point cloud
  ros::Subscriber sub = nh.subscribe<sensor_msgs::PointCloud2> ("/raw_pcd", 10, cloud_cb);

  // Create a ROS publisher for the output point cloud
  pub = nh.advertise<sensor_msgs::PointCloud2> ("/seg_cloud", 1);
